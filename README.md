...
# Summary
This project is a simple REST API that expands the experience of CatchUp application, the News API client app, with the possibility of saving favorite news sources. It is implemented with Java Language, Spring Boot Framework, Spring Data JPA ORM Library, and MySQL database. It also illustrates Domain-Driven Design approach with tactical patterns.
